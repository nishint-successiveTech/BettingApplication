...
// // //   Wallet
// // // } from "lucide-react";
// // // import { Sports } from "@mui/icons-material"; // Added MUI icon for My Bets
...
// // //   const [quickBetAmounts] = useState<number[]>([100, 500, 1000, 2000]);
// // //   const [countdown, setCountdown] = useState<string>("");
// // //   const [showMyBets, setShowMyBets] = useState<boolean>(false); // State to toggle My Bets view
// // //   const [userBets, setUserBets] = useState<Bet[]>([]); // State to store user's bets
...
// // //   useEffect(() => {
// // //     localStorage.setItem(`userBets_${userEmail}`, JSON.stringify(userBets));
// // //   }, [userBets, userEmail]);
...
// // //         matchId: cricketMatchId,
// // //         matchName: `${data?.cricketMatch.t1} vs ${data?.cricketMatch.t2}`
// // //       };

// // //       // Add the new bet to userBets array
...
// // //   const clearAllBets = () => {
// // //     if (window.confirm("Are you sure you want to clear all your bet history?")) {
// // //       setUserBets([]);
...
// // //           <span>{countdown}</span>
// // //         </div>
// // //         <button className="my-bets-button" onClick={toggleMyBets}>
// // //           <Sports fontSize="small" />
// // //           <span>My Bets ({userBets.length})</span>
// // //         </button>
// // //       </div>
...
// // //               {userBets.length > 0 && (
// // //                 <button className="clear-bets-btn" onClick={clearAllBets}>
// // //                   Clear All
// // //                 </button>
// // //               )}
// // //             </div>
...
// // //                   >
// // //                     <div className="bet-team">{bet.team}</div>
// // //                     <div className="bet-amount">₹{bet.amount.toLocaleString()}</div>
// // //                     <div className="bet-date">{bet.date}</div>
// // //                   </motion.div>
// // //                 ))}
...
// // //         .balance-info, .match-countdown, .my-bets-button {
// // //           display: flex;
// // //           align-items: center;
// // //           gap: 8px;
// // //           font-weight: 600;
...
// ... (your existing interfaces and GraphQL queries remain the same)
interface CricketMatchData {
  cricketMatch: {
    matchType: string;
    id: string;
