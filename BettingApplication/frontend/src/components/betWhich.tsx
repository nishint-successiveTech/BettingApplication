...
//           <CasinoIcon sx={{ fontSize: 60, color: '#00f5ff', mb: 2, animation: `${pulse} 2s infinite` }} />
//           <Typography
...
//               }}
//             >
//               <GroupsIcon sx={{ fontSize: 50, color: '#00f5ff', mb: 2 }} />
//               <Typography variant="h5" sx={{ color: '#fff', fontWeight: 'bold', mb: 2 }}>
//                 Team Betting
//               </Typography>
//               <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', mb: 3 }}>
//                 Place your bets on your favorite teams across various leagues and tournaments with competitive odds and real-time updates.
//               </Typography>
//               <Button
//                 fullWidth
//                 variant="contained"
...
//               }}
//             >
//               <TrendingUpIcon sx={{ fontSize: 50, color: '#ff00d4', mb: 2 }} />
//               <Typography variant="h5" sx={{ color: '#fff', fontWeight: 'bold', mb: 2 }}>
//                 Odds Betting
//               </Typography>
//               <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', mb: 3 }}>
