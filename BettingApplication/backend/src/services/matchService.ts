...
class MatchService {
  public static async seedMatches() {
    const matches: IMatch[] = [
      { teamA: "India", teamB: "Australia", status: "live", startTime: new Date() } as IMatch,
      { teamA: "England", teamB: "Pakistan", status: "upcoming", startTime: new Date(Date.now() + 3600000) } as IMatch,
      { teamA: "South Africa", teamB: "New Zealand", status: "completed", startTime: new Date(Date.now() - 7200000) } as IMatch,
    ];
